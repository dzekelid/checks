...
- name: Checks Job API - Get Checks Job
  x-api-slug: checkscheckidjob-get
...
- name: Checks Job API - Get Checks Job
  x-api-slug: checkscheckidjob-post
...
- name: Checks Ping API - Checks Ping
  x-api-slug: checkspingcheckid-put
...
- name: Checks Ping API - Checks Ping Locations
  x-api-slug: checkspinglocations-get
...
- name: Checks Port API - Checks Port
  x-api-slug: checksportcheckid-put
...
- name: Checks Port API - Checks Port Locations
  x-api-slug: checksportlocations-get
