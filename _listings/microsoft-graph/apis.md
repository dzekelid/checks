...
- name: Microsoft Graph API Group Check Member Groups
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/microsoft-graph/groups-id-checkmembergroups-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/microsoft-graph/groups-id-checkmembergroups-post-postman.md
x-common:
- type: x-change-loge
