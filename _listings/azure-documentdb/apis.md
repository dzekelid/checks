...
- name: Azure DocumentDB API Database Accounts Check Name Exists
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/azure-documentdb/providers-microsoft-documentdb-databaseaccountnames-accountname-head.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/azure-documentdb/providers-microsoft-documentdb-databaseaccountnames-accountname-head-postman.md
x-common:
