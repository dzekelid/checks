...
- name: Google Compute Engine API Delete Health Check
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/google-compute-engine/project-global-healthchecks-healthcheck-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/google-compute-engine/project-global-healthchecks-healthcheck-delete-postman.md
x-common:
- type: x-code
