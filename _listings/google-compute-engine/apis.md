...
apis:
- name: Compute Engine - Get Health Checks
  x-api-slug: projectglobalhealthchecks-get
...
- name: Compute Engine - Delete Health Check
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/google-compute-engine/projectglobalhealthcheckshealthcheck-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/google-compute-engine/projectglobalhealthcheckshealthcheck-delete-openapi.md
- name: Compute Engine - Get Health Check
  x-api-slug: projectglobalhealthcheckshealthcheck-get
...
- name: Compute Engine - Delete HTTP Health Check
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/google-compute-engine/projectglobalhttphealthcheckshttphealthcheck-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/google-compute-engine/projectglobalhttphealthcheckshttphealthcheck-delete-openapi.md
- name: Compute Engine - Create HTTP Health Check
  x-api-slug: projectglobalhttphealthcheckshttphealthcheck-get
...
- name: Compute Engine - Delete HTTPS Health Check
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/google-compute-engine/projectglobalhttpshealthcheckshttpshealthcheck-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/checks/master/_listings/google-compute-engine/projectglobalhttpshealthcheckshttpshealthcheck-delete-openapi.md
- name: Compute Engine - Get HTTPS Health Check
  x-api-slug: projectglobalhttpshealthcheckshttpshealthcheck-get
